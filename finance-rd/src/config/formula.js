...
export default
    ...
    switch (time) {
        case '本月':
            ...
            avgEndMonth = myDate.Format('yyyyMM')+'31';
        ...
        case '上月':
            ...
            budgetMonth = endMonth;
            avgEndMonth = addMonth(myDate,-1).Format('yyyyMM')+'31';
        ...
        case '上季':
            if(parseInt((myDate.Format('MM')/1+2)/3)==1) {
                ...
                budgetMonth = endMonth;
                avgEndMonth = (myDate.Format('yyyy')-1)+'1231';
                ...
                budgetMonth = endMonth;
                avgEndMonth = myDate.Format('yyyy')+('00'+(parseInt((myDate.Format('MM')/1+2)/3-1)*3)).slice(-2)+'31';
                syearMonth = myDate.Format('yyyy')+'0101';
            }
            l12sMonth = addMonth(myDate,-11).Format('yyyyMM');
            l12eMonth = myDate.Format('yyyyMM');
    ...
    let formula = {
        ...
        'home-overview': {
            ...
            qMeasures: [
                ...
                //战略产品
                `=num(sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'A','B','D','E','F','G','H','I'}>}DLV_QTY)+(sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'C'}>}${startMonth.substr(0,4)<2019?'DLV_QTY':'ZFI_PJSR'})/${startMonth.substr(0,4)<2019?1:5000}),'#,##0')`,
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'A','B','D','E','F','G','H','I'}>}DLV_QTY)+(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'C'}>}${startMonth.substr(0,4)<2019?'DLV_QTY':'ZFI_PJSR'})/${startMonth.substr(0,4)<2019?1:5000}))/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB003'}>}ZFI_MBZ),'0%')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'A','B','D','E','F','G','H','I'}>}DLV_QTY) +(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'C'}>}${startMonth.substr(0,4)<2019?'DLV_QTY':'ZFI_PJSR'})/${startMonth.substr(0,4)<2019?1:5000}))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'A','B','D','E','F','G','H','I'}>}DLV_QTY_LY) +(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'C'}>}${startMonth.substr(0,4)<2020?'DLV_QTY_LY':'ZFI_PJSR_LY'})/${startMonth.substr(0,4)<2020?1:5000})))/fAbs((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'A','B','D','E','F','G','H','I'}>}DLV_QTY_LY) +(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZGNGM={'国内'},ZFI_YWB={'C'}>}${startMonth.substr(0,4)<2020?'DLV_QTY_LY':'ZFI_PJSR_LY'})/${startMonth.substr(0,4)<2020?1:5000}))),'0%')`,
                //毛利额
                ...
                //人均销售额
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR)/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ))/2),'#,##0')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY)/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2),'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR)/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ))/2))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY)/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2)))/fAbs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY)/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2)),'0%')`,
                //人均扣费毛利
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"},ZYJBM={'产品研发中心'}>}ZFI_FY))/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ))/2),'#,##0')`,
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"},ZYJBM={'产品研发中心'}>}ZFI_FY_LY))/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2),'#,##0')`,
                `=num((((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"},ZYJBM={'产品研发中心'}>}ZFI_FY))/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ))/2))-((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"},ZYJBM={'产品研发中心'}>}ZFI_FY_LY))/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2)))/((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"},ZYJBM={'产品研发中心'}>}ZFI_FY_LY))/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2)),'0%')`,
                //美元
                //总收入
                ...
                //战略产品
                `=num(sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZFI_YWB={'A','B','D','E','F','G','H','I'}>}DLV_QTY)+(sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZFI_YWB={'C'}>}${startMonth.substr(0,4)<2019?'DLV_QTY':'ZFI_PJSR'})/${startMonth.substr(0,4)<2019?1:5000}),'#,##0')`,
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZFI_YWB={'A','B','D','E','F','G','H','I'}>}DLV_QTY)+(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZSTRATEGI={'X'},ZFI_YWB={'C'}>}${startMonth.substr(0,4)<2019?'DLV_QTY':'ZFI_PJSR'})/${startMonth.substr(0,4)<2019?1:5000}))/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB003'}>}ZFI_MBZ),'0%')`,
                ...
                `=sum(1)`,
                //人均销售额
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ))/2),'#,##0')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)/10000/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2),'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ))/2))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2)))/fAbs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)/((Sum({<CALMONTH={'${startMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALMONTH={'${avgEndMonth.substr(0,6)}'},ZGNGM={"$(vOrgFlagName)"},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2)),'0%')`,
                //人均扣费毛利
                `=sum(1)`,
                `=sum(1)`,
                `=sum(1)`
        ...
        'income-branch': {
            ...
            qMeasures: [
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY)/10000)`,
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR)/10000)`,
                `=round(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY))*100)`,
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)/10000)`,
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/10000)`,
                `=round(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY))*100)`,    
            ]
        },
        ...
        'cost-trend': {
            ...
            qMeasures: [
                `=round(Sum({<ZYJBM={'产品研发中心'},ZFYXZ={'人力成本'},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"}>}ZFI_FY)/Sum({<ZFI_XWLX={'YF-RS001'},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"}>}ZFI_MBZ_RS))`,
                `=round(Sum({<ZYJBM={'产品研发中心'},ZFYXZ-={'人力成本'},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"}>}ZFI_FY)/Sum({<ZFI_XWLX={'YF-RS001'},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"}>}ZFI_MBZ_RS))`,
                `=round(Sum({<ZYJBM={'产品研发中心'},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"}>}ZFI_FY)/Sum({<ZFI_XWLX={'YF-RS001'},${dataScope},${orgStr},ZGNGM={"$(vOrgFlagName)"}>}ZFI_MBZ_RS))`
            ]
        },
        'order-base': {
            qDimensions: [
