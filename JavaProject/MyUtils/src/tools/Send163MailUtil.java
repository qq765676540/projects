...
public class Send163MailUtil {
    ...
    static String FROM = "qq765676540@163.com"; // 发件人地址
    static String TO = "765676540@qq.com"; // 收件人地址
    static String AFFIX = ""; // 附件地址
    static String AFFIXNAME = ""; // 附件名称
    static String USER = "qq765676540@163.com"; // 用户名
    static String PWD = "Qwer1234"; // 163的授权码
    static String SUBJECT = "数据库表授权申请"; // 邮件标题
    static String[] TOS = {"765676540@qq.com"};
