...
public class ExcelHandle {
    ...
    public Dispatch addSheet() {
        ...
        return Dispatch.get(Dispatch.get(workbook, "sheets").toDispatch(),
                "add").toDispatch();
    ...
    public int getSheetCount() {
        ...
        int count = Integer.getInteger(Dispatch.get(getSheets(), "count")
                .toString());
    ...
    public void setValue(Dispatch sheet, String position, String type,
                         Object value) {
    ...
    public String getValue(String position, Dispatch sheet) {
