!function(t) {
    t.tablesort = function(e, s) {
        ...
        this.$sortCells.eq(s.split('|')[0]-1).on("click.tablesort",
        function() {
            i.sort(t(this),s.split('|')[1])
		}),
        this.index = null,
        this.$th = null,
        this.direction = null
    ...
    t.tablesort.prototype = {
        ...
        log: function(e) { (t.tablesort.DEBUG || this.settings.debug) && console && console.log && console.log("[tablesort] " + e)
        },
        destroy: function() {
