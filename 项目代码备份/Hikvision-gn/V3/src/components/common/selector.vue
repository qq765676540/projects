    ...
    >
        <div class="selector flex flex-column flex-1">
            ...
            <div class="selector-btn flex flex-justify-center">
                ...
                <div class="flex-1 selector-btn-cancle inactive" @click="cancle">取消</div>
                <div class="flex-1 selector-btn-confirm active" @click="confirm">确定</div>
                <div class="flex-1"></div>
            </div>
        </div>
    </transition>
    ...
    computed: {
        realTreeData() {
            if (
                ...
                // console.log('2019-05-08 17:45:35->YCQ日志记录:', deptNameArr);
                // console.log('2019-05-08 17:45:35->YCQ日志记录:', orgTreeData);
                return orgTreeData;
            }
            //默认数据
