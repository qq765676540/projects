        ...
        <div class="covered-customer-detail border-bottom" v-show="true">
            <div class="sub-title">
                ...
                <div class="col-xs-6 col-sm-6 text-right padding-empty" style="margin:5px 15px 0px 0px">
                    <my-actionsheet defSelected="全部" :data="['全部','战略客户','核心客户','潜力客户','认证客户']" :myStyle="{background:'rgba(239, 239, 239, 0.5)' ,width: '90px'}" @setScroll="setScrollStyleA"></my-actionsheet>
                </div>
            </div>
        ...
        <div class="uncovered-customer-detail border-bottom" v-show="true">
            <div class="sub-title">
                ...
                <div class="col-xs-6 col-sm-6 padding-empty text-right" style="margin:5px 15px 0px 0px">
                    <my-actionsheet defSelected="全部" :data="['全部','战略锁定','核心锁定','市场锁定','重要锁定']" :myStyle="{background:'rgba(239, 239, 239, 0.5)', width: '90px'}" @setScroll="setScrollStyleB"></my-actionsheet>
                </div>
            </div>
            <div style="margin:15px 15px 20px 15px;min-height:200px">
