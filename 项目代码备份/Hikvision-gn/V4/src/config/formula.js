export default
    ...
    var formula = {
        ...
        visitWarningKPI: {
            qDimensions: [],
            qMeasures: [
                `=count(distinct {<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},IsPartnerOrUser_Y={'Y','Z'},PartnerCategory_Y-={'其他'} >}Partner_EndUser_Y)/count(distinct{<[DimensionName]=,Statu={'完成分配'},IsPartnerOrUser={'Y','Z'},PartnerCategory-={'其他'},[是否拜访]={1}>}Partner_EndUser)*100`,
                `=count(distinct {<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},IsPartnerOrUser_Y={'N','Z'},UserCategory_Y-={'其他'} >}Partner_EndUser_Y)/count(distinct{<[DimensionName]=,Statu={'完成分配'},IsPartnerOrUser={'N','Z'},UserCategory-={'其他'},[是否拜访]={1}>}Partner_EndUser)*100`,
                `=count(distinct {<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},PartnerCategory_Y={"战略客户"},IsPartnerOrUser_Y={'Y','Z'}>} Partner_EndUser_Y) & '/' & count(distinct{<[DimensionName]=,Statu={'完成分配'},IsPartnerOrUser={'Y','Z'},PartnerCategory={'战略客户'},[是否拜访]={1}>}Partner_EndUser)`,
                `=count(distinct {<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},PartnerCategory_Y={"核心客户"},IsPartnerOrUser_Y={'Y','Z'}>} Partner_EndUser_Y)& '/' & count(distinct{<[DimensionName]=,PartnerCategory={"核心客户"},IsPartnerOrUser={'Y','Z'},[是否拜访]={1}>} Partner_EndUser)`,
                `=count(distinct{<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},PartnerCategory_Y={"潜力客户"},IsPartnerOrUser_Y={'Y','Z'}>} Partner_EndUser_Y)&'/' & count(distinct{<[DimensionName]=,PartnerCategory={"潜力客户"},IsPartnerOrUser={'Y','Z'},[是否拜访]={1} >} Partner_EndUser)`,
                `=count(distinct{<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},PartnerCategory_Y={"认证客户"},IsPartnerOrUser_Y={'Y','Z'}>} Partner_EndUser_Y)&'/' & count(distinct{<[DimensionName]=,PartnerCategory={"认证客户"},IsPartnerOrUser={'Y','Z'},[是否拜访]={1}>} Partner_EndUser)`,
                `=count(distinct{<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},UserCategory_Y={"战略锁定"},IsPartnerOrUser_Y={'N','Z'}>} Partner_EndUser_Y)&'/' & count(distinct{<[DimensionName]=,UserCategory={"战略锁定"},IsPartnerOrUser={'N','Z'},[是否拜访]={1}>} Partner_EndUser)`,
                `=count(distinct{<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},UserCategory_Y={"核心锁定"},IsPartnerOrUser_Y={'N','Z'}>} Partner_EndUser_Y)&'/' & count(distinct{<[DimensionName]=,UserCategory={"核心锁定"},IsPartnerOrUser={'N','Z'},[是否拜访]={1}>} Partner_EndUser)`,
                `=count(distinct{<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},UserCategory_Y={"市场锁定"},IsPartnerOrUser_Y={'N','Z'}>} Partner_EndUser_Y)&'/' & count(distinct{<[DimensionName]=,UserCategory={"市场锁定"},IsPartnerOrUser={'N','Z'},[是否拜访]={1}>} Partner_EndUser)`,
                `=count(distinct{<[DimensionName]={'${time}'},${orgStr},[RZTX/JH]={'T'},LogMode={'拜访'},UserCategory_Y={"重要锁定"},IsPartnerOrUser_Y={'N','Z'}>} Partner_EndUser_Y)&'/' & count(distinct{<[DimensionName]=,UserCategory={"重要锁定"},IsPartnerOrUser={'N','Z'},[是否拜访]={1}>} Partner_EndUser)`
            ]
        },
