...
export default
    ...
    let orgStr = "";
    let orgMatch = "";
    let branchDim = opt.dataScope == 'T' ? "='Total'" : (opt.dataScope == 'I' ? "[TXTSH_FGS]" : "TXTSH_XSBGS");
    ...
    let formula = {
        ...
        'home-overview': {
            ...
            qMeasures: [
                ...
                //毛利率
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY),'0%')`,
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY)),'0%')`,
                //扣费毛利
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY))/10000,'#,##0')`,
                `=num((Sum({<CALDAY={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY))/(Sum({<CALDAY={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB004'}>}ZFI_MBZ)-Sum({<CALDAY={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB002'}>}ZFI_MBZ)),'0%')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)))/fAbs((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY_LY))),'0%')`,
                //扣费毛利率
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY))/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR),'0%')`,
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY_LY))/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY),'0%')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY))/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR))-((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY_LY))/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY)),'0%')`,
                //人均销售额
                ...
                //人均扣费毛利
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY))/10000/((Sum({<CALDAY_NUM={'${startMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ)+Sum({<CALDAY_NUM={'${avgEndMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ))/2),'#,##0')`,
                `=num((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZYJBM={'产品研发中心'}>}ZFI_FY_LY))/10000/((Sum({<CALDAY_NUM={'${startMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY)+Sum({<CALDAY_NUM={'${avgEndMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_LY))/2),'#,##0')`,
                ...
                //毛利率
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_U)/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_U_LY)/Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY),'0%')`,
                ...
                `=sum(1)`,
                //人均销售额
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/10000/((Sum({<CALDAY_NUM={'${startMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U)+Sum({<CALDAY_NUM={'${avgEndMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U))/2),'#,##0')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)/10000/((Sum({<CALDAY_NUM={'${startMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U_LY)+Sum({<CALDAY_NUM={'${avgEndMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U_LY))/2),'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/((Sum({<CALDAY_NUM={'${startMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U)+Sum({<CALDAY_NUM={'${avgEndMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U))/2))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)/((Sum({<CALDAY_NUM={'${startMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U_LY)+Sum({<CALDAY_NUM={'${avgEndMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U_LY))/2)))/fAbs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY)/((Sum({<CALDAY_NUM={'${startMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U_LY)+Sum({<CALDAY_NUM={'${avgEndMonth}'},${dataScope},${orgStr},ZFI_XWLX={'YF-RS001'}>}ZFI_MBZ_U_LY))/2)),'0%')`,
                //人均扣费毛利
                `=sum(1)`,
                `=sum(1)`,
                `=sum(1)`
        ...
        'income-bp': {
            ...
            qMeasures: [
                ...
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR)/10000)`,
                ...
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB001'}>}ZFI_MBZ_U)/10000)`,
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/10000)`,
                ...
                `=round(Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB001'}>}ZFI_MBZ)/10000)`,
                `=round(Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR)/10000)`,
                `=round((Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR)-Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY))/fAbs(Sum({total <${orgFilterDim}> <CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_LY))*100)`,
                `=round(Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB001'}>}ZFI_MBZ_U)/10000)`,
                `=round(Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/10000)`,
                `=round((Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)-Sum(total <${orgFilterDim}> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY))/fAbs(Sum({total <${orgFilterDim}> <CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY))*100)`,
            ]
        },
        'income-structure-bar': {
            ...
            qMeasures: [
                ...
                `=round((Sum(total <TXTMD_HY> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)-Sum(total <TXTMD_HY> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY))/fAbs(total <TXTMD_HY> Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U_LY))*100)`,
                ...
                `=round(Sum(total <TXTMD_HY> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR)/10000)`,
                `=round(Sum(total <TXTMD_HY> {<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'}>}ZFI_PJSR_U)/10000)`,      
            ]
        },
        'income-branch': {
            qDimensions: [
        ...
        'income-trend': {
            ...
            qMeasures: [
                ...
                `=round(Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}ZFI_PJSR_U)/Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}DLV_QTY))`,
        ...
        'gross-bp': {
            ...
            qMeasures: [
                ...
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)/10000)`,
                `=round((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY))/fAbs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY))*100)`,
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFI_XWLX={'YF-MB004'}>}ZFI_MBZ_U)/10000)`,
                `=round(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFI_YWB={'A','B','C','D','E','F','G','H','I'},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_U)/10000)`,
        ...
        'gross-deduction': {
            ...
            qMeasures: [
                `=round(Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)/Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}ZFI_PJSR_LY)*100)`,
                `=round(Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)/Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}ZFI_PJSR)*100)`,
                `=round((Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_LY)-Sum({<ZYJBM={'产品研发中心'},${dataScope},${orgStr}>}ZFI_FY_LY))/Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}ZFI_PJSR_LY)*100)`,
                `=round((Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML)-Sum({<ZYJBM={'产品研发中心'},${dataScope},${orgStr}>}ZFI_FY))/Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}ZFI_PJSR)*100)`,
                `=round(Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_U_LY)/Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}ZFI_PJSR_U_LY)*100)`,
                `=round(Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr},ZFI_XWLX-={"*GN-ML*"}>}ZFI_PJML_U)/Sum({<ZFI_YWB={'A','B','C','D','E','F','G','H','I'},${dataScope},${orgStr}>}ZFI_PJSR_U)*100)`,
            ]
        },
        'cost-rate': {
            qDimensions: [
        ...
        'cost-structure': {
            ...
            qMeasures: [
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'人力成本'},ZYJBM={'产品研发中心'}>}ZFI_FY)/10000,'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'人力成本'},ZYJBM={'产品研发中心'}>}ZFI_FY))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'人力成本'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'人力成本'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'人力成本'},ZYJBM={'产品研发中心'}>}ZFI_FY)/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFYXZ={'人力成本'},ZFI_XWLX={'YF-MB002'}>}ZFI_MBZ),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'差旅费用'},ZYJBM={'产品研发中心'}>}ZFI_FY)/10000,'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'差旅费用'},ZYJBM={'产品研发中心'}>}ZFI_FY))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'差旅费用'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'差旅费用'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},ZFYXZ={'差旅费用'},ZYJBM={'产品研发中心'}>}ZFI_FY)/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},ZFYXZ={'差旅费用'},ZFI_XWLX={'YF-MB002'}>}ZFI_MBZ),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081008'},ZYJBM={'产品研发中心'}>}ZFI_FY)/10000,'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081008'},ZYJBM={'产品研发中心'}>}ZFI_FY))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081008'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081008'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081008'},ZYJBM={'产品研发中心'}>}ZFI_FY)/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081008'},ZFI_XWLX={'YF-MB002'}>}ZFI_MBZ),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066082001'},ZYJBM={'产品研发中心'}>}ZFI_FY)/10000,'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066082001'},ZYJBM={'产品研发中心'}>}ZFI_FY))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066082001'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066082001'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066082001'},ZYJBM={'产品研发中心'}>}ZFI_FY)/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066082001'},ZFI_XWLX={'YF-MB002'}>}ZFI_MBZ),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081304'},ZYJBM={'产品研发中心'}>}ZFI_FY)/10000,'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081304'},ZYJBM={'产品研发中心'}>}ZFI_FY))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081304'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081304'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081304'},ZYJBM={'产品研发中心'}>}ZFI_FY)/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081304'},ZFI_XWLX={'YF-MB002'}>}ZFI_MBZ),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081902'},ZYJBM={'产品研发中心'}>}ZFI_FY)/10000,'#,##0')`,
                `=num(((Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081902'},ZYJBM={'产品研发中心'}>}ZFI_FY))-(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081902'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)))/fabs(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081902'},ZYJBM={'产品研发中心'}>}ZFI_FY_LY)),'0%')`,
                `=num(Sum({<CALDAY_NUM={">=${startMonth}<=${endMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081902'},ZYJBM={'产品研发中心'}>}ZFI_FY)/Sum({<CALDAY_NUM={">=${startMonth}<=${budgetMonth}"},${dataScope},${orgStr},GL_ACCOUNT={'0066081902'},ZFI_XWLX={'YF-MB002'}>}ZFI_MBZ),'0%')`
            ]
        },
        'cost-trend': {
            qDimensions: [
            ...
            qMeasures: [
                `=round(Sum({<ZYJBM={'产品研发中心'},ZFYXZ={'人力成本'},${dataScope},${orgStr}>}ZFI_FY)/Sum({<ZFI_XWLX={'YF-RS001'},${dataScope},${orgStr}>}ZFI_MBZ))`,
                `=round(Sum({<ZYJBM={'产品研发中心'},ZFYXZ-={'人力成本'},${dataScope},${orgStr}>}ZFI_FY)/Sum({<ZFI_XWLX={'YF-RS001'},${dataScope},${orgStr}>}ZFI_MBZ))`,
                `=round(Sum({<ZYJBM={'产品研发中心'},${dataScope},${orgStr}>}ZFI_FY)/Sum({<ZFI_XWLX={'YF-RS001'},${dataScope},${orgStr}>}ZFI_MBZ))`
            ]
        },
        'order-base': {
            qDimensions: [
