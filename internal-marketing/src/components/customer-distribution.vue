...
<div class="vist-distribution flex flex-column">
    <div class="task-distribution flex-1 flex-column">
        ...
        <div class="task-distribution-middle flex flex-14 flex-row">
            <e-pie class="vist-e-pie flex" :pieConfig="config" :data="pieData" v-if="pieData"></e-pie>
        </div>
        <div class="task-distribution-bottom">
            <data-table orderBy="2|desc" :scrollY="180" :isShowTitle="true" :data="tableData" :title="['拜访任务类型','占比','次数']" v-if="tableData"></data-table>
        </div>
    </div>
