                ...
                <div class="sub-title">
                    ...
                    <div class="flex flex-1 flex-justify-right col-2-right-title" >
                        <div class="flex flex-justify-center flex-align-center" :style="{'color':col2LegendColor[3]}">
                            ...
                            <span>未执行计划数量<span :style="{'color': col2LegendColor[1]}">↓</span></span>
                        </div>
                    </div>
                </div>
...
import vantCollapse from "./common/vant-collapse-plan";
    ...
    computed: {
        ElineDataCSet() {
            if (this.$store.state.planExecutionLine.length > 0) {
                let dataArr = this.$store.state.planExecutionLine;
