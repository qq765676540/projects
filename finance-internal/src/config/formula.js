    ...
    let formula = {
        ...
        'over-all-ranking': {
            ...
            qMeasures: [
                ...
                `=Sum({<${timeYearEndDayStr},${orgStr},ZFI_XWLX={'GN-MB001'}>}ZFI_MBZ)-Sum({<${timeStr},${orgStr},ZSALESORG_FLAG={'分公司'},ZGNGM={'国内'},MATERIAL_FLAG={'收入物料'}>}ZFI_PJSR)`,
        ...
        'cost-pie': {
            qDimensions: [
                `=if(ZFYXZ<>'' and ZFYXZ<> '毛利扣减项',if(ZFYXZ='日常开支成本','日常开支',ZFYXZ))`,
            ],
            qMeasures: [
